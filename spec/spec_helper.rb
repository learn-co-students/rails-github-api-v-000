...
RSpec.configure do |config|
  ...
  config.before(:each) do
    ...
    stub_request(:post, "https://github.com/login/oauth/access_token").
      with(:body => {"client_id"=>"589849bbb84864e41ede", "client_secret"=>"2c80d1500ede46e0ce2969d2a9c46bf7b788f8d5", "code"=>"20"},
      ...
      to_return(:status => 200, :body => {"access_token"=>"1", "login"=>"your_username"}.to_json, :headers => {})
