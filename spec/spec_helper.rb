...
RSpec.configure do |config|
  ...
  config.before(:each) do
    stub_request(:get, "https://api.github.com/user/repos").
      with(:headers => {'Authorization'=>'token 1','Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3', 'User-Agent'=>'Faraday v0.9.1'}).
    ...
    stub_request(:post, "https://github.com/login/oauth/access_token").
      ...
      :headers => {'Accept'=>'application/json','Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3', 'User-Agent'=>'Faraday v0.9.1'}).
    ...
    stub_request(:post, "https://api.github.com/user/repos").
      ...
      :headers => {'Authorization'=>'token 1','Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3', 'User-Agent'=>'Faraday v0.9.1'}).
