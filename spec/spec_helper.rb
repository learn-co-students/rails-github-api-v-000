...
RSpec.configure do |config|
  ...
  config.before(:each) do
    stub_request(:get, "https://api.github.com/user/repos?affiliation=owner").
      with(:headers => {'Accept'=>'*/*', 'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3', 'Authorization'=>'token 1', 'User-Agent'=>'Faraday v0.9.1'}).
    ...
    stub_request(:post, "https://github.com/login/oauth/access_token").
      with(:body => {"client_id"=> ENV["GITHUB_CLIENT_ID"], "client_secret"=> ENV["GITHUB_CLIENT_SECRET"], "code"=>"20", "redirect_uri"=>"http://localhost:3000/auth"},
