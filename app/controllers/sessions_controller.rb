class SessionsController < ApplicationController
  ...
  def create
    token_resp = Faraday.post "https://github.com/login/oauth/access_token", {:client_id => ENV['GITHUB_CLIENT'], :client_secret => ENV['GITHUB_SECRET'], 'code' => "#{params[:code]}"}, {'Accept' => 'application/json'}
